 ...
 */
public class BackServiceImpl extends Service implements BackService {
    ...
    public static final String PREF_NAME = BackServiceImpl.class.getSimpleName();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        registerGcmAndConnect();

        return START_STICKY;
    }

    private void registerGcmAndConnect() {
    ...
    private void deleteRegistrationId() {
        SharedPreferences prefs = getApplicationContext().getSharedPreferences(PREF_NAME,
                Context.MODE_PRIVATE);
        prefs.edit().remove(GCM_REGISTRATION_ID_KEY);
    }
    ...
    public class LocalBinderImpl extends Binder implements LocalBinder {

        @Override
        public BackService getService() {
            return BackServiceImpl.this;
        }
    }
